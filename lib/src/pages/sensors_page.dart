...
import 'package:psycare/src/utils/SensorInfoHolder.dart';
...
class SensorsPage extends StatefulWidget {
  static final String routeName = 'sensors';

  @override
  _SensorPageState createState() => _SensorPageState();
}

class _SensorPageState extends State<SensorsPage> {
  final prefs = new PreferenciasUsuario();

  static String _methodChannelName =
      'com.example.psycare.androidMethodChannel'; // keep it unique
  static String _eventChannelName =
      'com.example.psycare.androidEventChannel'; // keep it unique too
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('Valores de Sensores Activos'),
          backgroundColor:
              (prefs.colorSecundario) ? Colors.purple : Colors.blue,
        ),
        drawer: MenuWidget(),
